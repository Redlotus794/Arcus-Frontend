    ...
    >
      ...
      <a-form-item
        ...
        :rules="[
          ...
          { maxLength: 20, message: $t('register.form.username.maxLength') }
        ]"
      ...
      <a-form-item
        ...
        :rules="[
          ...
          { match: /^1[3-9]\d{9}$/, message: $t('register.form.phone.format') }
        ]"
        :validate-trigger="['change', 'blur']"
        hide-label
      >
      ...
      <a-form-item
        ...
        :rules="[
          ...
          { minLength: 6, message: $t('register.form.password.minLength') }
        ]"
        :validate-trigger="['change', 'blur']"
        hide-label
      >
      ...
      <a-space :size="16" direction="vertical">
        ...
        <div class="register-form-agreement">
          <a-checkbox
            ...
            :rules="[{ required: true, message: $t('register.form.agreement.errMsg') }]"
          >
        ...
        <!-- 返回登录 -->
        <a-button type="text" long class="register-form-login-btn" @click="goToLogin">
...
<script lang="ts" setup>
  ...
  import { ValidatedError, FieldRule } from '@arco-design/web-vue/es/form/interface';
